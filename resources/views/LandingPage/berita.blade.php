        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="page-banner-box text-white">
                    ...
                    <h1 class="mt-3 mb-3" style="font-weight: 700;color: #fff">Berita Terbaru</h1>
                    <p class="mb-0" style="max-width: 580px; font-size: 16px; line-height: 1.7;color: #fff">
                        Dapatkan informasi terkini dan pengumuman penting dari sekolah.
                    </p>
                </div>
            </div>
        </div>
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center py-5">
                            <h3 class="text-muted">Belum ada berita yang dipublikasikan</h3>
                            <p class="text-muted">Berita akan muncul di sini setelah dipublikasikan oleh admin.</p>
                        </div>
                    </div>
                @endforelse
            </div>
