...
<div class="row">
	<div class="col-md-12 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<h6 class="card-title">Edit Berita / Materi Belajar</h6>
				...
				<form action="{{ route('dashboard.beritas.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control @error('kategori') is-invalid @enderror" 
							...
							<option value="materi_belajar" {{ old('kategori', $berita->kategori) == 'materi_belajar' ? 'selected' : '' }}>Materi Belajar</option>
						</select>
						@error('kategori')
					...
					<div class="mt-3">
						<button type="submit" class="btn btn-primary mr-2">
							<i data-feather="save" class="mr-2"></i>Update
						</button>
